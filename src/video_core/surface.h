 ...
 * texture formats.
 */
constexpr u32 GetCompressionFactor(PixelFormat format) {
...
constexpr u32 GetDefaultBlockWidth(PixelFormat format) {
    if (format == PixelFormat::Invalid)
        return 0;
...
constexpr u32 GetDefaultBlockHeight(PixelFormat format) {
    if (format == PixelFormat::Invalid)
        return 0;
...
constexpr u32 GetBytesPerPixel(PixelFormat pixel_format) {
